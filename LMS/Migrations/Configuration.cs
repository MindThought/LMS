		...
		protected override void Seed(ApplicationDbContext context)
		{
			...
			context.Activities.AddOrUpdate(
				...
				new Activity
				{
					...
					Module = context.Modules.Where(m => m.Name == "C#").FirstOrDefault(),
					Type = Models.ActivityType.ELearning,
					StartTime = new DateTime(2017, 8, 12, 13, 0, 0),
					EndTime = new DateTime(2017, 8, 23, 20, 0, 0),
					Description = "The Advance of C# on <a href= https://app.pluralsight.com/library/courses/c-sharp-fundamentals-with-visual-studio-2015 > course </a>"
				}
				);
